...
# -*- coding: utf-8 -*-
#
# widgetbackend documentation build configuration file
#
...
project = 'widgetbackend'
copyright = '2021, vishnudatha'
author = 'vishnudatha'
...
_version_py = os.path.join(repo, 'widgetbackend', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'widgetbackenddoc'
...
latex_documents = [
    (master_doc, 'widgetbackend.tex', 'widgetbackend Documentation',
     'vishnudatha', 'manual'),
]
